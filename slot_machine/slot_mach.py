...
def deposit():
    #collecting user input, that gets deposit from the user
    while True:
...
#getting the number of lines the user wants to input 
...
#how much they would like to bet
def get_bet():
